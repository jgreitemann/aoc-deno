...
// source-hash: 0c2824621f078452b815591bbd9b99c4750f7657
let wasm;
 ...
 * @returns {string}
 */
export function crackPassword(input) {
  let deferred2_0;
  let deferred2_1;
  try {
    ...
    wasm.crackPassword(retptr, ptr0, len0);
 ...
 *   exports: { crackPassword: typeof crackPassword }
 * }>}
 */
export async function instantiateWithInstance(opts) {
  const { instance } = await loader.load(
    opts?.url ?? new URL("aoc_2016_day05_wasm_bg.wasm", import.meta.url),
    opts?.decompress,
  );
